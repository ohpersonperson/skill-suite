# IFS Interrogation — reference index

Read in this order when you need the full protocol behind SKILL.md.

- **evidence-taxonomy.md** — the 10-tier evidence classification plus the overlay-only OBFUSCATION tag. Read before decomposing any field.
- **prior-state.md** — loading prior Keys, the five dispositions (HELD / CRACKED / MODIFIED / SUPERSEDED / UNRESOLVED), historical integrity rules.
